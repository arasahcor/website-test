...
export default function Mission() {
  return (
    <section className="my-24 grid justify-items-between max-w-2xl grid-cols-1 lg:max-w-none mx-6 lg:grid-cols-2 gap-6 ">
      <div className=" text-left font-monument break-words uppercase font-regular md:text-subtitle text-22s text-white">
        <h2>
